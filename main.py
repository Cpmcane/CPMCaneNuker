...
from Cpmcane import CaneXEwanTool

__CHANNEL_USERNAME__ = "CPMCANETOOL"
__GROUP_USERNAME__   = "CANEXEWAN CHEAT"
...
colors = [
    ...
    console.print("[bold green]♕ CaneXEwanTool[/bold green]: Car Parking Multiplayer Hacking Tool.")
